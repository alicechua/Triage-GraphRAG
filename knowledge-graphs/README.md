...
### Step 3 — (Optional) Apply data quality corrections
```bash
python clean_kg.py
...
### Step 5 — Audit guidelines (retroactive rule cleanup)
```bash
...
### Step 6 — Multi-agent graph audit
```bash
...
### Step 7 — Build semantic vector index
```bash
cd vector_db/
